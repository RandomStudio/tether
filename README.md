...
- `base_agent`
  - `js`: Base agent in Javascript, suitable for both NodeJS and browser environments. You don't even have to use this (see a few examples below). [JS Base Agent README](./base_agent/js/README.md)
